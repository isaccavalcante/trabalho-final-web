...
Data: <input type="text" name="data" value="${data}" style="width:50%"> <br />
Moto:<input type="text" name="moto" style="width:50%"> <br />
Placa:<input type="text" name="placa" style="width:50%"> <br />
Pago: &nbsp;&nbsp;&nbsp;<input type="text" style="height:25px;width:50px" name="valorPago"> <br />
Débito: <input type="text" style="height:25px;width:50px" readonly name="debito"> <br />
